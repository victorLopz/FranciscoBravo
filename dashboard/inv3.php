...
<?php
    ...
    $consulta = "SELECT al.IDCodigoAlmacen, al.Codigo1, al.Codigo2, al.NombreArticulo, al.Modelopresentacion, al.precioVenta, al.PrecioCompra, altres.Stock, al.Marca, al.Notas FROM almacen as al INNER JOIN almacentres as altres ON altres.IDCodigoAlmacenPK = al.IDCodigoAlmacen where al.IsVisible = 1 AND altres.Stock > 0";
