...
<?php
    ...
    $consulta = "SELECT al.IDCodigoAlmacen, al.Codigo1, al.Codigo2, al.NombreArticulo, al.Modelopresentacion, al.precioVenta, al.PrecioCompra, aluno.Stock, al.Marca, al.Notas FROM almacen as al INNER JOIN almacenuno as aluno ON aluno.IDCodigoAlmacenPK = al.IDCodigoAlmacen where al.IsVisible = 1 AND aluno.Stock > 0";
