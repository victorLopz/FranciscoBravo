...
switch($agregarproducto){
    ...
    case 2:
        ...
        $consulta = "INSERT INTO almacenuno(IDCodigoAlmacenPK, Stock, Notas) VALUES((SELECT IDCodigoAlmacen  FROM almacen ORDER BY IDCodigoAlmacen DESC LIMIT 1), '0', '$comentario') ";			
        $resultado = $conexion->prepare($consulta);
        $resultado->execute();
