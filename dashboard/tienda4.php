  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="./inv4.php" class="small-box-footer">Mas informacion <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="his4.php" class="small-box-footer">Mas informacion<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
        ...
        <a href="./stockañadidos.php?almacen=4"><button type="button" class="btn btn-outline-primary btn-lg"><i class="fa fa-bell"></i> Stock Añadidos</button></a>
    ...
    $consul = "SELECT deta.IDFacturaDetalle, 
                      ...
                      WHERE al.IsVisible = 1 and fac.AlmacenNumero = 4";
    $consulta = $consul;
