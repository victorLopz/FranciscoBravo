...
<?php
    ...
    $consulta = "SELECT al.IDCodigoAlmacen, al.Codigo1, al.Codigo2, al.NombreArticulo, al.Modelopresentacion, al.precioVenta, al.PrecioCompra, alcuatro.Stock, al.Marca, al.Notas FROM almacen as al INNER JOIN almacencuatro as alcuatro ON alcuatro.IDCodigoAlmacenPK = al.IDCodigoAlmacen where al.IsVisible = 1 AND alcuatro.Stock > 0";
